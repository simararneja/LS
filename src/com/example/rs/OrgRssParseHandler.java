...
public class OrgRssParseHandler extends DefaultHandler {
	private List<OrgRssItem> rssItems;
	private OrgRssItem currentItem;
	...
	public OrgRssParseHandler() {
		rssItems = new ArrayList<OrgRssItem>();
	}
	
	public List<OrgRssItem> getItems() {
		return rssItems;
	}
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		else if ("WorkResponsibility".equals(qName)) {
