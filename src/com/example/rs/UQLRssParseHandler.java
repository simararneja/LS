...
public class UQLRssParseHandler extends DefaultHandler {

	private List<UQLRssItem> rssItems;
	
	private UQLRssItem currentItem;
	...
	public UQLRssParseHandler() {
		rssItems = new ArrayList<UQLRssItem>();
	}
	
	public List<UQLRssItem> getItems() {
		return rssItems;
	}
