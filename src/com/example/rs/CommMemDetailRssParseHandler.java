...
public class CommMemDetailRssParseHandler extends DefaultHandler {

	private List<CommMemDetailRssItem> rssItems;
	
	private CommMemDetailRssItem currentItem;
	...
	public CommMemDetailRssParseHandler() {
		rssItems = new ArrayList<CommMemDetailRssItem>();
	}
	
	public List<CommMemDetailRssItem> getItems() {
		return rssItems;
	}
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		if ("Committees".equals(qName)) {
			currentItem = new CommMemDetailRssItem();
