...
public class OrgDesigListListener implements OnItemClickListener {
    // Our listener will contain a reference to the list of RSS Items
    // List item's reference
    List<OrgDesigRssItem> listItems;
    // And a reference to a calling activity
    // Calling activity reference
    Activity activity;
    /** We will set those references in our constructor.*/
    public OrgDesigListListener(List<OrgDesigRssItem> aListItems, Activity anActivity) {
