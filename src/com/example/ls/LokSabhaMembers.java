...
public class LokSabhaMembers extends Activity {
	...
	private class GetListOfMemberRSSDataTask extends AsyncTask<String, Void, List<LoMRssItem> > {
	    @Override
	    protected List<LoMRssItem> doInBackground(String... urls) {
	        ...
	        try {
	            // Create RSS reader
	            ListOfMemberRSSReader rssReader = new ListOfMemberRSSReader(urls[0]);
