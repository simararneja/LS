...
public class GovtBillRssParseHandler extends DefaultHandler {

	private List<GovtBillRssItem> rssItems;

	private GovtBillRssItem currentItem;
	...
	public GovtBillRssParseHandler() {
		rssItems = new ArrayList<GovtBillRssItem>();
	}

	public List<GovtBillRssItem> getItems() {
		return rssItems;
	}
	...
	public void startElement(String uri, String localName, String qName,
		...
		if ("Member".equalsIgnoreCase(qName)) {
			currentItem = new GovtBillRssItem();
